...
// Get the values of "name of submission" and "co-ordinates of walk" fields
let nameofsubmission = document.querySelector('#nofsub').value;
let coordinates = document.querySelector('#coord').value;

// Check if these fields are filled
if (nameofsubmission === '' || coordinates === '') {
